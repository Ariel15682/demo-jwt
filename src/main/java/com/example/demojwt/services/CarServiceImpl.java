...
import com.example.demojwt.repository.CarRepository;
...
public class CarServiceImpl implements CarService{
    ...
    public void deleteByid(Long id) {
        ...
        try{
            ...
            log.error("Trying to delete car by id {}", id, e);
        }
    }
    ...
    @Override
    public Long count(){
        log.info ("Get total numbers of cars");
    ...
    @Override
    public List<Car> findByModelContaining(String model) { return this.carRepository.findByModelContaining(model); }

    @Override
    public List<Car> findByYearIn(List<Integer> years) { return this.carRepository.findByYearIn(years); }
    ...
    @Override
    public List<Car> findByAvailableTrue() { return this.carRepository.findByAvailableTrue(); }
